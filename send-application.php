...
$pdf->FieldRow('Date of Birth', $d['dob'] ?? '', 'SSN', $d['ssn'] ?? '');
$pdf->FieldRow("Driver's License", $d['drivers_license'] ?? '', 'DL State', $d['drivers_license_state'] ?? '');
...
$pdf->FieldRow('Form of Income', $d['form_of_income'] ?? '', 'Other Income', '$' . ($d['other_income'] ?? '0'));
$pdf->Ln(3);
